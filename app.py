...
def require_admin() -> None:
    ...
    st.markdown('<div class="login-footer"><strong>عبدالله محمد</strong><br><span>تواصل معي عبر واتساب الشخصي</span><br><a class="whatsapp-link" href="https://wa.me/97058727698" target="_blank">فتح واتساب الشخصي</a><br><small>+97058727698</small></div>', unsafe_allow_html=True)
